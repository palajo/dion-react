...
import ProductInfo from "./PhotopanelProductInfo";
...
const PhotopanelProductView = ({match}) => {
    ...
    const product = PhotopanelApi.find(item => item.id === match.params.id);
    console.log(PhotopanelApi, match.params.id)
...
export default PhotopanelProductView;