...
import PhotopanelVariationSlider from "../slider/PhotopanelVariationSlider";
...
export const PhotopanelProductInfo = ({productImage, productType, productVendor, productCategory, productDescription, productPrice}: ProductInfoProps) => {
    return (
...
export default PhotopanelProductInfo;