...
import ProductInfo from "./TurboProductInfo";
...
const TurboProductView = ({match}) => {
    
    const product = TurboApi.find(item => item.id === match.params.id);
    console.log(TurboApi, match.params.id)
...
export default TurboProductView;