...
import PremiumVariationSlider from "../slider/PremiumVariationSlider";
...
export const PremiumProductInfo = ({productImage, productType, productVendor, productCategory, productDescription, productPrice}: ProductInfoProps) => {
    return (
