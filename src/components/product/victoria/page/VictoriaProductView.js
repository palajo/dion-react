...
import ProductInfo from "./VictoriaProductInfo";
...
const VictoriaProductView = ({match}) => {
    
    const product = VictoriaApi.find(item => item.id === match.params.id);
    console.log(VictoriaApi, match.params.id)
...
export default VictoriaProductView;