...
import VictoriaVariationSlider from "../slider/VictoriaVariationSlider";
...
export const VictoriaProductInfo = ({productImage, productType, productVendor, productCategory, productDescription, productPrice}: ProductInfoProps) => {
    return (
...
export default VictoriaProductInfo;