...
const VictoriaApi = [
    {
        categoryId: 'Victoria',
        id: 'victoria-jsd-08-summer',
        image: VictoriaSummer,
        imagesmall: VictoriaSummerSmall,
        brand: 'Victoria',
        model: 'JSD-08',
        title: 'Лето',
        type: 'Дымоходная',
    ...
    {
        categoryId: 'Victoria',
        id: 'victoria-jsd-08-waterfall',
        image: VictoriaWaterfall,
        imagesmall: VictoriaWaterfallSmall,
        brand: 'Victoria',
        model: 'JSD-08',
        title: 'Водопад',
        type: 'Дымоходная',
